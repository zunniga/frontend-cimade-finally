...
const Book = () => {
  ...
  const onSubmit: SubmitHandler<any> = async (data, event) => {
    ...
    console.log(data);
    setSending(true);
    const serviceID = "service_knr79n9";
    const templateID = "template_bvnqg59";
  ...
  return (
    <section className="mt-28 bg-testBlue/20 mb-24">
      <div className="max-w-screen-lg mx-auto">
        ...
        <div className="p-2">
          <h1 className="uppercase text-primaryblue text-center md:text-3xl text-2xl font-extrabold">
            Hoja de Reclamación
          </h1>
          <p className="text-center mb-2 text-primaryblue font-semibold">
            Binex Educación Continua
          </p>
          <h2 className="bg-primaryblue p-3 text-lg font-semibold text-gray-50 rounded-xl">
        ...
        >
          ...
          <div className="text-gray-500">
            ...
            {errors.nombres && (
              <p>El campo nombre debe contener menos de 20 caracteres</p>
            )}
          </div>
          ...
          <input
            ...
            className="border-2 p-2 mb-6 rounded-xl bg-primaryblue text-gray-200 text-xl font-bold cursor-pointer"
          />
        </form>
      </div>
    </section>
