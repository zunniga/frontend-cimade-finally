  ...
  return (
    ...
    <div className="mx-auto ">
      ...
      <section className="">
        ...
        <div className=" container px-6 md:px-12 mb-48"> bg-gradient-to-b  via-[] 
          <div className="bg-gradient-to-b  from-[#2878b7]/50 to-[#124654]/50   block rounded-lg  px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
