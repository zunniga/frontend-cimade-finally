...
const Index = () => {
  ...
  <div className="relative  lg:h-[400px] md:h-[350px] h-[200px] overflow-hidden bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('/img/contact/7119.jpg')"}}></div>
