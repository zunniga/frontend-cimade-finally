...
const GraduateCard: FC<InsightCardProps> = ({
  imgUrl,
  title,
  subtitle,
  index,
  ...
  >
    ...
    <div className="w-full flex items-center justify-center px-2">
      <div className="flex-1 flex flex-col max-w-[650px] items-center">
        <Link
          href="/graduate"
          className="uppercase text-xs font-extrabold flex justify-center bg-transparent text-white border p-2 md:mt-2 mt-6 mb-4 w-36 rounded-lg hover:scale-110 duration-200 hover:bg-testBlue"
        >
          Ver curso
        </Link>
      </div>
