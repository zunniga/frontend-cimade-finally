...
export const modulesSolidWaste = [
    ...
    {name: "Operatividad de las Empresas Operadoras de Residuos Sólidos", text:"Hola, deseo más información sobre el curso de Operatividad de las Empresas Operadoras de Residuos Sólidos"},
