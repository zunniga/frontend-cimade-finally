...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/brochuress/BROCHURE RIEGO Y FERTIRRIEGO-BINEX.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/brochuress/BROCHURE RIEGO Y FERTIRRIEGO-BINEX.pdf';
    link.download = 'BROCHURE RIEGO Y FERTIRRIEGO-BINEX.pdf';
    link.click();
  };
