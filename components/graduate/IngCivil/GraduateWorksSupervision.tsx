...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/brochuress/Brochure - RYSO.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/brochuress/Brochure - RYSO.pdf';
    link.download = 'Brochure - RYSO.pdf';
    link.click();
  };
                    ...
                    <motion.li
                      ...
                      onClick={() => {
                        if (item.text) {
                          ...
                          // Manejar el caso en que item.text sea undefined
                          console.error(
                            "El texto no está definido para el ítem ",
                            item
                          );
                        }
                      }}
