...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/brochuress/Brochure - INGENIERIA DE PUENTES.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/brochuress/Brochure - INGENIERIA DE PUENTES.pdf';
    link.download = 'Brochure - INGENIERIA DE PUENTES.pdf';
    link.click();
  };
