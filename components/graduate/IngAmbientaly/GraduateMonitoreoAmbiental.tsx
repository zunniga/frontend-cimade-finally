...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/brochuress/BROCHURE MONITOREO Y EVALUACIÓN DE LA CALIDAD AMBIENTAL.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/brochuress/BROCHURE MONITOREO Y EVALUACIÓN DE LA CALIDAD AMBIENTAL.pdf';
    link.download = 'BROCHURE MONITOREO Y EVALUACIÓN DE LA CALIDAD AMBIENTAL.pdf';
    link.click();
  };
