...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/brochuress/Brochure Gestión ambiental municipal y regional.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/brochuress/Brochure Gestión ambiental municipal y regional.pdf';
    link.download = 'Brochure Gestión ambiental municipal y regional.pdf';
    link.click();
  };
