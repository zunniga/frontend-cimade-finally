...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/brochuress/BROCHURE GESTIÓN DE LA CALIDAD E INOCUIDAD ALIMENTARIA.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/brochuress/BROCHURE GESTIÓN DE LA CALIDAD E INOCUIDAD ALIMENTARIA.pdf';
    link.download = 'BROCHURE GESTIÓN DE LA CALIDAD E INOCUIDAD ALIMENTARIA.pdf';
    link.click();
  };
