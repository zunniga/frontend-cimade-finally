...
const [imageUrl, setImageUrl] = useState('');
  ...
  const handleClick = () => {
    const newWindow = window.open('/brochuress/Brochure de SSOMA.pdf');
    setOpenWindow(newWindow);

    // Descargar el archivo PDF
    const link = document.createElement('a');
    link.href = '/brochuress/Brochure de SSOMA.pdf';
    link.download = 'public/brochuress/Brochure de SSOMA.pdf';
    link.click();
  };
